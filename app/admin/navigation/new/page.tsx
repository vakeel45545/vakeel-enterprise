    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Add Nav Item</h1>
          <p className="text-sm text-gray-500 mt-1">
            Create a new navbar item. Choose type <strong>Mega Menu</strong> to add categories, links, and a featured card.
          </p>
        </div>
