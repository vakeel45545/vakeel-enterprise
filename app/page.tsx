          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-24">
            ...
            >
              ...
              <motion.div variants={FADE_UP} className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-premium shadow-premium mb-8 border-sage/15 text-sage font-bold text-xs uppercase tracking-widest">
                ...
                <span>Vakeel AI OS 2.0 Live</span>
              </motion.div>
              ...
              >
                Everything your startup needs to launch, scale, and stay compliant. Unified in one intelligent, zero-error dashboard.
              </motion.p>

              <motion.div variants={FADE_UP} className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-base shadow-premium-hover bg-charcoal hover:bg-sage text-white transition-all transition-spring transform hover:-translate-y-1 group border border-charcoal/20">
                  Start Your Business
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 text-base glass-premium shadow-premium border-charcoal/10 hover:bg-white hover:border-sage/30 transition-all transition-spring hover:-translate-y-1">
                  Talk to an Expert
                </Button>
              </motion.div>
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-[1440px]">
          ...
          >
            ...
            <motion.p variants={FADE_UP} className="text-charcoal/55 text-lg md:text-xl leading-relaxed text-balance">
              Eliminate disjointed portals. Vakeel unifies incorporation, tax, and IP into a single beautifully engineered workspace.
            </motion.p>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 xl:gap-32">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sage/10 border border-sage/20 mb-8 text-xs font-bold uppercase tracking-widest text-sage">
                <SparklesIcon className="w-3.5 h-3.5" /> Intelligence Layer
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold mb-6 leading-[1.08] text-charcoal tracking-tight">Your 24/7 personal <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-sage to-emerald-600">Chief Legal Officer.</span></h2>
              <p className="text-charcoal/60 text-lg lg:text-xl xl:text-2xl mb-10 max-w-lg leading-relaxed font-medium">
                Upload massive contracts for instant plain-English summaries, get automated compliance reminders, and resolve complex tax queries in seconds.
              </p>
      ...
      <section className="py-32 md:py-48 bg-charcoal text-white relative overflow-hidden rounded-t-[3rem] mt-4 noise-overlay">
        ...
        >
          ...
          <motion.p variants={FADE_UP} className="text-xl lg:text-2xl xl:text-3xl text-white/60 max-w-3xl mx-auto mb-14 text-balance leading-relaxed font-medium">
            Join 50,000+ ambitious founders who trust Vakeel to keep their businesses legally bulletproof.
          </motion.p>
          <motion.div variants={FADE_UP} className="flex flex-col sm:flex-row justify-center gap-4 lg:gap-6">
            <Button size="lg" className="bg-white text-charcoal hover:bg-sage hover:text-white shadow-premium-hover h-16 lg:h-20 px-10 lg:px-12 text-lg font-bold w-full sm:w-auto group rounded-[1.25rem] transition-all transition-spring">
              Get Started Now <ArrowRight className="w-6 h-6 ml-2.5 group-hover:translate-x-1 transition-transform" />
            </Button>
             <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 h-16 lg:h-20 px-10 lg:px-12 text-lg font-bold w-full sm:w-auto rounded-[1.25rem] backdrop-blur-md">
          ...
          <motion.div variants={FADE_UP} className="mt-20 flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-white/40 text-sm font-bold uppercase tracking-wider">
             ...
             <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sage" /> 100% online process</div>
             <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-sage" /> Dedicated account manager</div>
          </motion.div>
        </motion.div>
      </section>
