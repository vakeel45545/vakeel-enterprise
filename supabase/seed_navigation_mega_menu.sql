-- ============================================================
-- POPULATE mega_menu_data FOR ALL PARENT NAVIGATION ITEMS
...
-- Also ensure all parent items have visible = true
UPDATE public.navigation
SET visible = true
WHERE parent_id IS NULL;

-- Verify the update worked
SELECT id, title, type, visible,
  CASE WHEN mega_menu_data IS NOT NULL THEN 'HAS DATA' ELSE 'NULL' END AS mega_menu_status
